...
func New(c *conf.Config) cache.Cmdable {
	addr := c.Cache.Addr
...
func (r *redisImpl) HDel(ctx context.Context, key string) cache.IntCmd {
...
func (p *pipelineImpl) HDel(ctx context.Context, key string) cache.IntCmd {
	return p.p.HDel(ctx, key)
}

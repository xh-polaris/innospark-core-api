...
type Conversation struct {
	...
	BotId          string             `json:"bot_id" bson:"bot_id"`                               // intelligence_id
	VL             bool               `json:"vl,omitempty" bson:"vl,omitempty"`                   // 是否启用视觉
	Ext            map[string]string  `json:"ext,omitempty" bson:"ext,omitempty"`                 // 额外信息

...
type FeedBack struct {
	MessageId  primitive.ObjectID `json:"message_id" bson:"_id"`                              // 用message_id作为主键, 一个消息只会有一条feedback
	UserId     primitive.ObjectID `json:"user_id" bson:"user_id"`                             // 用户id
	Action     int32              `json:"action,omitempty" bson:"action,omitempty"`           // 触发反馈的原因, none/like/dislike/delete 0/1/2/3
